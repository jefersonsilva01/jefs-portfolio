...
import { Header } from './HeroStyle';

const Hero = props => {
  return (
    <Header id="hero" color={`${props.theme}`}>
      <nav>
        {/* <h2>JEF'S.</h2> */}
        <div id="icons">
          <div id="icon-lang" onClick={() => props.changeLang()}>
          ...
          <div id="icon-theme" onClick={() => props.changeTheme()}>
      ...
      <main>
        <div id="title">
          ...
          <div>
            {props.theme
              ...
              : <img src="./assets/Lightning icon-light.svg" alt="Lightning" />
            }
          </div>
        </div>
        ...
        <p>
          {props.lang
            ? ("Criar soluções vai além do código — é sobre transformar ideias em experiências funcionais e envolventes. Neste portfólio, você encontrará projetos que refletem minha paixão por desenvolvimento e inovação. Explore e descubra o que podemos construir juntos!")

            : ("Creating solutions goes beyond code—it's about transforming ideas into functional and engaging experiences. In this portfolio, you will find projects that reflect my passion for development and innovation. Explore and discover what we can build together!")
          }
        </p>
        ...
        {props.theme
          ...
          : <img src="./assets/Scroll icon dark.svg" alt="scroll icon" />
        }
      </main>
    </Header>
  );
